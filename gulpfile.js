...
gulp.task("js", function () {
  return gulp
    .src([
      ...
      // path + 'libs/mixitup/dist/mixitup.min.js',
      // path + 'libs/scroller/jquery.li-scroller.1.0.js',
      // path + 'libs/mousewheel/jquery.mousewheel.min.js',
      // path + 'libs/jquery.touchSwipe.min.js',
      // path + 'libs/nicescroll/jquery.nicescroll.min.js',
      ...
      path + 'libs/odometer/odometer.js',
...
gulp.task("svgSprite", function () {
  return (
    gulp
    .src(path + "img/svg/*.svg") // svg files for sprite
    .pipe(
      svgSprite({
        mode: {
          stack: {
...
gulp.task(
  "default",
  gulp.parallel("watch", "clear", "html", "sass", "js", "browser-sync")
);
